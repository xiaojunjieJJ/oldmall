...
import com.example.mall.seckill.vo.SeckillSessionsWithSkus;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    public void upSeckillSkuLatest3Days() {
        ...
        if (session.getCode() == 0) {
            //上架商品
            List<SeckillSessionsWithSkus> sessionData = session.getData2("data", new TypeReference<List<SeckillSessionsWithSkus>>() {
            });
            //缓存到redis
            //1.缓存活动信息
